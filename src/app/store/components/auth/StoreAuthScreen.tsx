      ...
      <div className="mx-auto ct-shell px-2 py-2">
        <div className="overflow-hidden rounded-[22px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.92)_0%,rgba(248,250,252,0.95)_100%)] shadow-[0_20px_60px_rgba(15,23,42,0.10)] backdrop-blur">
          <div className="relative">
            ...
            <div className="relative ct-tab-frame px-4 py-4">
              <div className="grid h-full w-full gap-5 lg:grid-cols-[1.08fr_0.92fr]">
                <section className="rounded-[28px] border border-slate-200/80 bg-white/78 p-7 shadow-[0_10px_26px_rgba(15,23,42,0.05)] backdrop-blur">
                  <div className="flex items-center gap-4">
                    <div className="relative h-[72px] w-[220px] shrink-0">
                      <Image
                  ...
                  <div className="mt-8">
                    <div className="text-[26px] font-extrabold leading-[1.08] text-slate-900">
                    ...
                    <div className="mt-7 grid gap-3 sm:grid-cols-2">
                      <div className="rounded-[18px] border border-slate-200 bg-white px-4 py-4 shadow-[0_4px_14px_rgba(15,23,42,0.03)]">
                        <div className="text-[14px] font-extrabold text-slate-900">⚡ Rápido</div>
                      ...
                      <div className="rounded-[18px] border border-slate-200 bg-white px-4 py-4 shadow-[0_4px_14px_rgba(15,23,42,0.03)]">
                        <div className="text-[14px] font-extrabold text-slate-900">🔒 Seguro</div>
                        <div className="mt-1 text-[13px] leading-snug text-slate-600">
                      ...
                      <div className="rounded-[18px] border border-slate-200 bg-white px-4 py-4 shadow-[0_4px_14px_rgba(15,23,42,0.03)]">
                        <div className="text-[14px] font-extrabold text-slate-900">💰 Ganancias</div>
                        <div className="mt-1 text-[13px] leading-snug text-slate-600">
                      ...
                      <div className="rounded-[18px] border border-slate-200 bg-white px-4 py-4 shadow-[0_4px_14px_rgba(15,23,42,0.03)]">
                        <div className="text-[14px] font-extrabold text-slate-900">🧾 Pedidos</div>
                        <div className="mt-1 text-[13px] leading-snug text-slate-600">
                    ...
                    <div className="mt-7 rounded-[20px] bg-slate-900 px-5 py-5 text-white shadow-[0_10px_24px_rgba(15,23,42,0.10)]">
                      <div className="text-[14px] font-extrabold">Tip operativo</div>
                      <div className="mt-1 text-[13px] leading-relaxed text-white/80">
                        Recuerda Iniciar/Cerrar sesión con tu usuario al Iniciar/Terminar tu turno de trabajo.
                      </div>
                    </div>
                  </div>
                </section>
                      ...
                      <>
                        ...
                        <div className="mt-6 space-y-4">
                          ...
                          {forgotStep === "CONFIRM" ? (
                            <>
                              <div>
                                <div className="text-[13px] font-extrabold text-slate-700">Código</div>
                                <input
                                  value={resetCode}
                          ...
                          <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-4 text-[13px] leading-snug text-slate-600">
                            Si no recibes el código, verifica tu número/email asociado o contacta soporte.
                          </div>
                        </div>
                      </>
                    )}
